...
[ShaderGraphMaterial](https://developer.apple.com/documentation/realitykit/shadergraphmaterial): the Overview section has presentation errors.
...
Option+Click the mask parameter of CollisionFilter to bring Xcode documentation. It says:
...
But that is wrong. `theFilter` should be:
